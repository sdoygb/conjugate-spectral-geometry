...
三个扇区的 Dirac 谱通过 Birkhoff 矩阵 $T$ 互相依赖，由不动点方程 $\sigma^* = M_5 \sigma^* / \|M_5 \sigma^*\|$ 确定：
...
不同扇区的扰动代价不同——信息扇区 ℐ 的扰动代价最高，物质扇区 ℳ 的扰动代价最低。原因在于代数作用量 $S(\sigma) = \frac{1}{C^2}\sum_i 1/\sigma_i$ 的 Hessian 对角元 $H_{ii} = \partial^2 S / \partial\sigma_i^2 = 2/(C^2\sigma_i^3) \propto 1/\sigma_i^3$：
