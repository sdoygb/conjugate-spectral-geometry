...
本文是几何论系列论文的第 9.1 篇。该系列的基础框架（唯一公理δ、Clifford代数、编码轨道结构、Born法则、相互作用映射）已在共扼谱几何基础定理中建立。
...
| 常数 | 数值 | 来源 | 地位 |
|:---|:---|:---|:---|
| Sₑ | 137.035999084 | 圆满再现定理 1.1.5.01-20 | 几何本征量 |
| mₑ | 510.99895 keV | 圆满再现 |
| K | 839.758793 keV | 圆满再现定理 1.1.5.01-20 | 质量量子 |
| λ₁（裸） | 392.21 rad⁻² | Birkhoff混合矩阵不动点处二阶结构 | 谱间隙方向 |
| λ₂（裸） | 58760.77 rad⁻² | Birkhoff混合矩阵不动点处二阶结构 | Dirac谱方向 |
| λ₁ᵉᶠᶠ | 391.05 rad⁻² | 跨扇区耦合 | 有效谱间隙方向 |
| λ₂ᵉᶠᶠ | 59324.3 rad⁻² | 跨扇区耦合 | 有效Dirac谱方向 |
| χL | 1.509×10⁻¹⁰ m | 定理 1.1.5.01（谱展开/Born法则） | 长度标度 |
| χT | 3.616×10⁻¹⁷ s | 定理 1.1.5.01（谱展开/Born法则） | 时间标度 |
| Λ | 3 | 互锁常数 | 三等分 |
| k₀ | 2 | 互锁常数 | 二分紧致性 |
| Γ_{geo} | 5.75×10⁻²³ | 定理 3.2.2.01（信息场衰减定理） | 信息场几何衰减率 |
| τ_{dec} | 7.28日 | 定理 3.2.2.01（信息场衰减定理） | 信息场退相干时间 |
| N_{dec} | 1.74×10²² | 定理 3.2.2.01（信息场衰减定理） | 退相干事件数 |
| c | 2.99792458×10⁸ m/s | 圆满再现零锥固定点 | 圆满再现零锥固定点 |
...
| 材料 | εₚₐᵢᵣⁿᵒʳᵐ | ℰ_{geo} | ℰ_{phys} (meV) | 实验 (meV) | Tc (K) | 实验 (K) | 偏差 |
|:---|:---|:---|:---|:---|:---|:---|:---|
...
| N | N_{eff} | δ₀(N) | lnΩ₀(N,2) | kB Tc (meV) | Tc (K) |
|:---|:---|:---|:---|:---|:---|
...
| Tc 公式 | 1.13\,ΘD\,e^{-1/N(0)V} | E_{scale}· gₚₐᵢᵣ·δ₀²/lnΩ₀ |
...
|:---:|:---|:---:|:---:|:---:|:---|
| **A** | Z₂可超导 | K̃⁰=ℤ^{N_{eff}-1} | 3,5,7 | ✅ | R3̄m(166), Fd3̄m(227) |
| **B** | 镜面对称可超导 | K̃⁰=ℤ^{N_{eff}-1} | 5 | ✅ | Fm3̄m(225), Pm3̄m(221) |
| **C** | 非中心对称条件可超导 | K̃⁰=ℤ^{N_{eff}-1}(条件) | 3 | 🟡条件性 | F4̄3m(216), I4̄3m(217) |
| **D** | 磁性可超导（需修正） | K̃⁰≠0(PT保护) | 3-7 | 🟡修正后 | R3̄c(167), P4/nmm(129,反铁磁) |
| **E** | 不可超导 | K̃⁰=0 | 1 | ❌ | 其他全部 |

**A类（Z₂可超导，约20个空间群）**：

| 晶系 | 空间群 | N_{eff} | 已知材料 | Tc范围(K) |
|:---|:---:|:---:|:---|:---:|
| 菱方 R3̄m(166) | R3̄m | 7 | Bi₂Se₃, Bi₂Te₃, Sb₂Te₃ | 276-438 |
| 立方 Fd3̄m(227) | Fd3̄m | 7 | Bi₀.₉Sb₀.₁ | 475 |
| 六方 P6₃/mmc(194) | P6₃/mmc | 5 | — | — |

**B类（镜面对称可超导，约15个空间群）**：

| 晶系 | 空间群 | N_{eff} | 已知材料 | Tc范围(K) |
|:---|:---:|:---:|:---|:---:|
| 面心立方 Fm3̄m(225) | Fm3̄m | 5 | SnTe, PbTe, PbSe | 193-228 |

**C类（非中心对称条件可超导，约25个空间群）**：

| 空间群 | N_{eff} | 有效材料 | Tc(K) |
|:---:|:---:|:---|:---:|
| F4̄3m(216) | 3 | YPtBi✅, LuPtBi✅ | 18-21 |
...
|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| Bi₂Se₃纳米线 | R3̄m(166) | Z₂强TI | ✅ | ✅ N_{eff}=7 | ✅ | 🟢超导 | 438(预测) |
| SnTe纳米线 | Fm3̄m(225) | TCI镜面 | ✅ | ✅ N_{eff}=5 | ✅ | 🟢超导 | 228(预测) |
| YPtBi纳米线 | F4̄3m(216) | 非中心对称 | ✅ | ✅ N_{eff}=3 | ✅ | 🟢超导 | 21(预测) |

**已知非超导体的判据不通过**：

| 材料 | 空间群 | 类型 | Q1 | Q2 | Q3 | 判据 | 实验 |
|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| Cu | Fm3̄m(225) | 普通金属 | ❌ | ❌ | ✅ | 🔴不超导 | ✅ |
| Fe | Im3̄m(229) | 铁磁金属 | ❌ | ❌ | ❌磁性 | 🔴不超导 | ✅ |
| Si | Fd3̄m(227) | 普通半导体 | ❌ | ❌ | ✅ | 🔴不超导 | ✅ |
| SiO₂ | P3₂21(154) | 普通绝缘体 | ❌ | ❌ | ✅ | 🔴不超导 | ✅ |
| Fe₂O₃ | R3̄c(167) | 反铁磁绝缘体 | ❌ | ❌ | ❌磁性 | 🔴不超导 | ✅ |
...
| 空间群 | 编号 | 点群 | 候选评级 | 代表材料 | Tc (K) |
|:---|:---:|:---:|:---:|:---|:---:|
| P6₃/mmc | 194 | D₆ₕ | 强候选 | UPt₃ | 0.53 |
| Im3̄ | 204 | Tₕ | 候选 | PrOs₄Sb₁₂ | 1.85 |
| Fd3̄m | 227 | Oₕ | 候选 | Bi₂Pd | 3.9-7.8 |
| R3̄m | 166 | D_{3d} | 候选 | Bi₂Se₃族 | 276-438 |
| F4̄3m | 216 | Td | 候选 | YPtBi, LuPtBi | 18-21 |
| I4/mmm | 139 | D₄ₕ | **非候选** | Sr₂RuO₄ | — |
| Immm | 71 | D₂ₕ | **非候选** | UTe₂ | — |
...
| 缺口 | 封闭方法 | 状态 |
|:---|:---|:---:|
| δ₀(N) 标度律 | 谐振子零点宽度K-理论并联升级 | ✅ 定理级 |
| lnΩ₀ 公式 | HRR定理RMT谱熵双重锁定 | ✅ 定理级 |
| Tc公式结构 | 熵稀释的谱间隙方向失稳条件 | ✅ 定理级 |
| Eₜₒₚₒ 公式 | Dirac锥曲率能谱展开/Born法则维度压缩 | ✅ 定理级（幂次残余） |
| 温度谱展开/Born法则 | ℳ𝒞ℰ 三扇区热核系数比闭合 | 🟡 框架内自洽 |

**关键参数**（全几何锁定，无外部拟合）：

| 参数 | 数值 | 来源 |
|:---|:---|:---|
| vF | 5.07×10⁵ m/s | 定理 9.1.5.02（指标定理） |
| r_{phys} | 10 nm | 实验可调参数 |
| r_{geo} | r_{phys}/χL = 66.3 | 谱展开/Born法则映射 |
| N | 7 | 构造参数 |
| gₚₐᵢᵣ | 4.282 | sinθCᵉ/sinθIᵉ |
| δ₀(7) | 0.4575 | δ₀ˢⁱⁿᵍˡᵉ·√7 |
| lnΩ₀(7,2) | 0.854 | HRR四项公式 |
| Eₜₒₚₒ | 36.0 meV | Dirac锥曲率能 |
...
| 化合物 | vF (10⁵ m/s) | Z₂确认 | ARPES确认 | 体Tc (K) | 三螺旋Tc (K) | 置信度 |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
...
| 家族 | 结构 | 保护 | N_{eff} | 材料 | Tc (K) | 理论状态 |
|:---|:---:|:---:|:---:|:---|:---:|:---:|
| **R3̄m** | 菱方 | Z₂ | 7 | Bi₂Se₃ | **438** | 🟢 定理级 |
| | | | | Bi₂Te₃ | **346** | 🟢 |
| | | | | Sb₂Te₃ | **276** | 🟢 |
| | | | | Bi₂Te₂Se | **388** | 🟢 |
| | | | | MnBi₂Te₄ | **388** | 🟢 |
| **Fm3̄m** | 岩盐 | 镜面 | 5 | SnTe | **228** | 🟢 定理级 |
| | | | | Pb₀.₆Sn₀.₄Te | **203** | 🟢 |
| **F4̄3m** | 立方 | Z₂ | 3 | YPtBi | **21** | 🟢 定理级 |
| | | | | LuPtBi | **18** | 🟢 定理级 |
| | | | | LaPtBi | **38**(条件) | 🟡 条件性 |
...
| 编号 | 定理 | 内容 | 状态 |
|:---:|:---|:---|:---:|
| T1 | vF 严格公式 | vF = c·(λ₁ᵉᶠᶠ)^{3/2}/(Sₑ²·√λ₂ᵉᶠᶠ) | ✅ 定理级 |
| T2 | Bott周期性七层截断 | N_{eff}≤7 由三重封印锁定 | ✅ 定理级 |
| T3 | d_{IR} 的K-理论解释 | d_{IR} = rank(K̃⁰) + 1 | ✅ 定理级 |
| T4 | δ₀(N) 标度律 | δ₀(N) = δ₀ˢⁱⁿᵍˡᵉ·√N_{eff} | ✅ 定理级 |
| T5 | lnΩ₀ 双路径锁定 | HRRRMT双重验证 | ✅ 定理级 |
| T6 | Tc公式熵稀释推导 | kB Tc = E_{scale}· gₚₐᵢᵣ·δ₀²/lnΩ₀ | ✅ 定理级 |
| T7 | gₚₐᵢᵣ=4.282 | sinθCᵉ/sinθIᵉ | ✅ 严格 |
| T8 | Eₜₒₚₒ 公式 | Dirac锥曲率能维度压缩 | ✅ 定理级（幂次残余） |

### 13.2 框架内条件性（待依赖环节闭环）

| 编号 | 缺口 | 当前状态 | 影响范围 | 修复方向 |
|:---:|:---|:---:|:---|:---|
| C1 | 体材料 Δ Sₚₐᵢᵣ 的几何理论 | 15=dim𝔰𝔭𝔦𝔫(6) 依赖选群唯一性 | 体材料路径 | 完成辛约化选群唯一性论证 |
| C2 | 温度谱展开/Born法则 ΞT 的独立计算 | 热核系数比依赖测试函数选择 | 理论自洽性闭环 | zeta函数正则化路径 |
| C3 | Eₜₒₚₒ 中 sin³θM 幂次唯一性 | 层级分辨率确定但非唯一 | Tc 变动±15-18% | 谱展开/Born法则层级乘子序列严格推导 |
...
|:---:|:---|:---|
| 🔴 | Ψₘ 的第一性原理推导 | 框架结构假设 |
| 🔴 | ΞE 的独立数值计算（不依赖Tc反推） | Dixmier迹形式定义，数值待定 |
| 🔴 | c₂(TM_{bulk})=100 的严格推导 | 数值猜想 |
| 🟡 | n=22 双重推导路径的等价性证明 | 待证框架内对偶 |
| 🟡 | 𝔰𝔭𝔦𝔫(6) 选群的唯一性论证 | 辛约化ansatz |
| 🟡 | γ（无序强度）↔ S(q) 映射 | 开放研究方向 |
| 🔵 | 退相干-Tc关系（猜想10.3）的严格推导 | 探索性猜想 |
| 🔵 | M_{bulk} 微分拓扑的框架内定义 | 开放研究方向 |
| 🔵 | 2D边缘态 Tc 适用性 | 需新Tc公式（1维扇区参数空间） |
...
| 项目 | 地位 | 说明 |
|:---|:---|:---|
| Sₑ, λ₁, λ₂, K, χL, χT, Λ, k₀ | **纯几何输出** | 框架锁定 |
| Γ_{geo}, τ_{dec}, N_{dec} | **纯几何输出** | 锁定 |
| θM⁰, θC⁰, θI⁰ | **纯几何输出** | 电子基态构型 |
| εₚₐᵢᵣⁿᵒʳᵐ=15·(λ₁/λ₂)· Sₑ⁻¹ | **几何构造**（给定ansatz） | 15依赖 𝔰𝔭𝔦𝔫(6) 选择 |
| n=22（谱流整数） | **几何构造** | 双重推导等价性待证 |
| Ψₘ=4816.51 | **框架结构假设** | 第一性原理推导待建立 |
| ΞE | **形式定义** | 数值独立计算待建立 |
| c₂(TM_{bulk})=100 | **数值猜想** | 推导链未闭合 |
| N, p, N_{orb}, η, m*, θ, γ, n_{dis}, χ, nB, a, ZH | **条件参数** | 材料特定输入 |
...
| 2 | K-理论 | 定理 9.1.3.01：d_{IR}=K-群秩 | 全部 | 严格 |
| 3 | K-理论 | 定理 9.1.3.02：N_{eff}≤7=Bott周期 | 全部 | 严格 |
| 4 | 非交换几何 | 定理 9.1.4.02：ΞE=Dixmier迹 | 全部 | 严格（形式） |
| 5 | 指标定理 | 定理 9.1.5.02：vF=指标体积 | 拓扑纳米线 | 严格 |
| 6 | 层论 | 定理 9.1.6.01：lnΩ₀=Euler示性数 | 全部 | 严格 |
| 7 | 层论Clifford | 定理 9.1.6.03：εₚₐᵢᵣⁿᵒʳᵐ | 全部 | 严格（给定ansatz） |
| 8 | RMT | 定理 9.1.7.02：lnΩ₀=谱熵 | 全部 | 严格 |
| 9 | 谱理论 | 定理 9.1.9.05：pₒₚₜ=22/Sₑ | 铜基 | 严格 |
...
| 标架 | 三分解(e₁… e₉) | 本文定理 | 锁死内容 |
|:---|:---|:---|:---|
| ℳ扇区{e₁,e₂,e₃} | 物质界标架 | 定理 9.1.2.03, 2.7 | 谱间隙方向频率 λ₁ 由Hamilton流锁定 |
| 𝒞扇区{e₄,e₅,e₆} | 因果界标架 | 定理 9.1.6.01, 6.3 | 配对能标由Ext群锁定 |
| ℐ扇区{e₇,e₈,e₉} | 信息界标架 | 定理 9.1.3.02, 9.1 | Bott周期截断 N_{eff}≤7 |
| 一阶条件 [[𝒟,a],Jb*J⁻¹]=0 | 𝒞⊕ℐ 扇区互扼 | 定理 9.1.3.01, 15.1 | λ₂/λ₁≈150 谱刚性 |
| 谱间隙方向分离 λ₁ᵉᶠᶠ | ℳ 扇区独立 | 定理 7.14.2.01, 10.2 | 面内谱间隙方向=λ₁/N_{eff} |
| Dirac谱方向分离 λ₂ᵉᶠᶠ | 𝒞⊕ℐ 扇区联合 | 定理 7.14.2.02, 9.4 | 层间刚度=λ₂sin²θI/N_{eff} |
